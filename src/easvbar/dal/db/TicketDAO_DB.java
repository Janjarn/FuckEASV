...
public class TicketDAO_DB implements ITicket {
    ...
    public List<Ticket> getAllTickets() throws Exception {
             ...
             Statement stmt = conn.createStatement())
        {
            ...
            while (rs.next()) {
                ...
                Ticket ticket = new Ticket (ticketId,qrCode,barcode,vipTicket,foodTicket,beerTicket,firstRow);
    ...
    public Ticket createTicket(Ticket ticket) throws Exception {
        String sql = "INSERT INTO FuckEASVBar.dbo.Ticket (QrCode,Barcode,VipTicket,FoodTicket,BeerTicket,FirstRow) VALUES (?,?,?,?,?,?);";
